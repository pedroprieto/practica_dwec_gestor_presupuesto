...
gastosFiltrados = gestionPresupuesto.filtrarGastos( {etiquetas:"comida, transporte", valorMaximo:50} );
for ( let gasto of gastosFiltrados ){
    gestionPresupuesto.mostrarGastoWeb( "listado-gastos-filtrado-4", gasto );
}
