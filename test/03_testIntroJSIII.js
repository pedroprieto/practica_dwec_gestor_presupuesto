...
describe('Función CrearGasto y funcionamiento de objeto gasto', function () {
  it("Método 'obtenerPeriodoAgrupacion' del objeto gasto", function () {
    const gasto1 = new CrearGasto('Gasto 1', 23.55, '2021-09-06', 'casa', 'supermercado')
    const gasto2 = new CrearGasto('Gasto 2', 27.55, '2021-11-24', 'casa', 'supermercado', 'comida')
...
describe('Función filtrarGastos', function () {
  it("Filtra los gastos (variable global 'gastos') de acuerdo con los parámetros pasados a la función", function () {
    ...
    const gasto1 = new CrearGasto('Compra carne', valor1, '2021-10-06', 'casa', 'comida')
    const gasto2 = new CrearGasto('Compra fruta y verdura', valor2, '2021-09-06', 'supermercado', 'comida')
    const gasto3 = new CrearGasto('Bonobús', valor3, '2020-05-26', 'transporte')
    const gasto4 = new CrearGasto('Gasolina', valor4, '2021-10-08', 'transporte', 'gasolina')
    const gasto5 = new CrearGasto('Seguro hogar', valor5, '2021-09-26', 'casa', 'seguros')
    const gasto6 = new CrearGasto('Seguro coche', valor6, '2021-10-06', 'transporte', 'seguros')
    anyadirGasto(gasto1)
    anyadirGasto(gasto2)
    anyadirGasto(gasto3)
    anyadirGasto(gasto4)
...
describe('Función agruparGastos', function () {
  it('Realiza una agrupación de gastos por períodos temporales', function () {
    ...
    const agrup1 = agruparGastos('mes')
    ...
    const agrup2 = agruparGastos('dia')
    ...
    const agrup3 = agruparGastos('mes', ['transporte'])
    ...
    const agrup4 = agruparGastos('anyo', ['transporte', 'casa'])
    ...
    const agrup5 = agruparGastos('mes', ['transporte'], '2021-01-01')
    ...
    const agrup6 = agruparGastos('mes', ['transporte'], '2021-10-01', '2021-10-07')
