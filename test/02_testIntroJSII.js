...
describe('Función CrearGasto y funcionamiento de objeto gasto', function () {
  it('CrearGasto: comprobación con fecha y etiquetas', function () {
    ...
    const descr = 'Ejemplo de gasto'
    const gasto1 = new CrearGasto(descr)
    ...
    const gasto2 = new CrearGasto(descr, 23.55)
    ...
    const gasto3 = new CrearGasto(descr, 23.55, '2021-10-06T13:10Z')
    ...
    const gasto4 = new CrearGasto(descr, 23.55, '2021-10-06T13:10Z', 'casa')
    ...
    const gasto5 = new CrearGasto(descr, 23.55, '2021-10-06T13:10Z', 'casa', 'supermercado')
    ...
    const gasto6 = new CrearGasto(descr, 23.55, '2021-10-06T13:10Z', 'casa', 'supermercado', 'comida')
  ...
  it("Método 'mostrarGastoCompleto' del objeto gasto", function () {
    const valor = 23.55
    const fechalocale = new Date('2021-10-06T13:10Z').toLocaleString()
    const gasto1 = new CrearGasto('descripción del gasto', valor, '2021-10-06T13:10Z', 'casa', 'supermercado', 'comida')
...
`)
  ...
  it("Método 'actualizarFecha' del objeto gasto", function () {
    const orig = Date.parse('2021-10-06T13:10Z')
    const nueva = Date.parse('2021-11-11T13:10Z')
    const gasto1 = new CrearGasto('descripción del gasto', 23.55, '2021-10-06T13:10Z')
  ...
  it("Método 'anyadirEtiquetas' del objeto gasto", function () {
    ...
    const gasto2 = new CrearGasto('descripción del gasto', valor, '2021-10-06T13:10Z')
  ...
  it("Método 'borrarEtiquetas' del objeto gasto", function () {
    ...
    const gasto2 = new CrearGasto('descripción del gasto', valor, '2021-10-06T13:10Z', 'casa', 'supermercado', 'comida')
    gasto2.borrarEtiquetas('supermercado', 'casa')
    assert.lengthOf(gasto2.etiquetas, 1)
    assert.equal(gasto2.etiquetas[0], 'comida')

    const gasto3 = new CrearGasto('descripción del gasto', valor, '2021-10-06T13:10Z', 'casa', 'supermercado', 'comida')
    ...
    const gasto4 = new CrearGasto('descripción del gasto', valor, '2021-10-06T13:10Z', 'casa', 'supermercado', 'comida')
...
describe('Función anyadirGasto', function () {
  it("Añade el gasto que se pasa como parámetro a la variable global 'gastos'", function () {
    ...
    const gasto1 = new CrearGasto('descripción del gasto', valor1, '2021-10-06T13:10Z', 'casa', 'supermercado', 'comida')
    const gasto2 = new CrearGasto('descripción del gasto', valor2, '2021-10-06T13:10Z', 'casa', 'supermercado', 'comida')
    const gasto3 = new CrearGasto('descripción del gasto', valor3, '2021-10-06T13:10Z', 'casa', 'supermercado', 'comida')
...
describe('Función borrarGasto', function () {
  it("Elimina de la variable global 'gastos' el gasto cuyo id se pasa como parámetro", function () {
    ...
    const gasto4 = new CrearGasto('descripción del gasto', valor4, '2021-10-06T13:10Z', 'eti1', 'supermercado', 'comida')
