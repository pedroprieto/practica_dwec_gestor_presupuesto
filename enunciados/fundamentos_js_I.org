...
4. *Añadir el remoto secundario* a tu repositorio personal. Para ello hay que ejecutar el comando:
   ...
   #+end_src
5. Incorporar a tu repositorio personal los cambios correspondientes a los archivos de esta práctica. Para ello hay que ejecutar:
   #+begin_src shell
     git pull profesor
   #+end_src
...
7. Ejecuta el comando ~git push~ para subir los cambios a tu repositorio personal en GitHub y que queden guardados ahí también.
...
9. Ejecutar el comando ~npm test~ para lanzar los tests. Este comando podrá ejecutarse tantas veces como sea necesario. Por pantalla se mostrarán los tests que se pasan y los que no, de manera que se tendrá información sobre las acciones que hay que realizar.
